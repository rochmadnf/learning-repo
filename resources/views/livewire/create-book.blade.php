<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 text-gray-900">
        <form wire:submit.prevent='submit' class="flex items-start gap-x-3">
            ...
            <button type="submit"
                class="bg-blue-500 text-white py-2 px-4 rounded-lg disabled:p-2 font-medium disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer">
                {{-- <span wire:loading.delay.long class="inline-flex items-center justify-center">
                ...
                <span wire:loading.delay.long>Loading</span>
